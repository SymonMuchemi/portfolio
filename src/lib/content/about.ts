...
export const aboutSection: AboutSectionType = {
  title: 'about me',
  paragraphs: [
    "I have developed and maintained scalable back-end services and APIs, leveraging Express (TypeScript) and Flask (Python). I optimized database performance with MongoDB (Mongoose), PostgreSQL, and MySQL while implementing Sequelize ORM and SQLAlchemy for efficient data management. My experience extends to cloud computing, where I containerized applications using Docker, deployed services on AWS (EC2, S3, Secrets Manager), and automated CI/CD pipelines with GitHub Actions.",
    "Beyond back-end development, I have worked on caching strategies (Redis), message queuing, and API security with JWT authentication and SSL/TLS encryption. I also integrate AI/ML capabilities (LLMs) into applications to enhance intelligence and predictive functionalities.",
